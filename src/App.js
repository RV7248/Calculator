...
// To format integer values --> (comma between digits)
...
function App() {
  ...
  return (
    <>
      ...
      <h1 className='heading'>CalculatorX</h1>
      <div className="container">
        <div className="calculator-grid">
          ...
          <button className="span-two del" onClick={() => dispatch({ type: ACTIONS.CLEAR })}>AC</button>
      ...
      {/* For background particle movement */}
